  ...
  return (
    ...
    <div className='my-7 sm:my-0 max-w-[1200px] h-screen mx-auto flex flex-col-reverse sm:flex-row justify-center align-center' id='about'>
        <div className='flex-col my-auto mx-auto'>
            ...
            <h1 className='md-text-7xl sm:text-6xl text-4xl font-bol md:py-6'>
                <TypeAnimation
                sequence={[
                    'Web Developer',
                    1000,
    ...
    <a href="https://github.com/ianbeguas">
        <AiFillGithub/>
            ...
            <div className='relative inline-flex group my-3'>
                ...
                from-[#44BCFF] via-[#FF44EC] to-[#FF675E] rounded-xl blur-lg group-hover:opacity-100 group-hover: inset-1 group-hover:duration-200'>
                </div>
