        ...
        <div className='lg:py-10 sm:py-0 text-gray-200' id='banner'>
            <div className='max-w-6xl mx-auto px-6 md:px-10 flex flex-col-reverse sm:flex-row justify-center items-center gap-12' >
                ...
                <div className='flex flex-col justify-center items-center sm:items-start'>
                    ...
                    <h1 className='text-4xl font-bold py-6 lg:text-5xl md:text-4xl'>
                        <TypeAnimation
                            sequence={[
                                'Web Developer',
                                1000,
                    ...
                    <p className='text-lg font-bold text-gray-400 text-center sm:text-left lg:text-2xl md:text-2xl'>
                        Turning pixels into experiences <br /> one line of code at a time.
                    </p>
                    
                    <div className='text-5xl flex justify-center sm:justify-start gap-10 my-7 text-purple-600'>
